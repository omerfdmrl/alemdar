#ifndef ALEMDAR_LAYER_MAX_POOLING_2D_H

#define ALEMDAR_LAYER_MAX_POOLING_2D_H

ALEMDAR_DEF void layer_max_pooling_2d_forward(Layer layer);
ALEMDAR_DEF Layer layer_max_pooling_2d(size_t inputSize, int poolSize);

void layer_max_pooling_2d_forward(Layer layer) {
    int index = 0;
    float max_val;
...
Layer layer_max_pooling_2d(size_t inputSize, int poolSize) {
    ...
    l.forward = layer_max_pooling_2d_forward;
    l.bias = vec_alloc(0);
...
#endif // !ALEMDAR_LAYER_MAX_POOLING_2D_H